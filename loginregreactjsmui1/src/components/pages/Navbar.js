...
const Navbar = () => {
  ...
  <AppBar position="static" color="secondary">
   <Toolbar>
    ...
    ) => { return {backgroundColor: isActive ? "#6d1b7b" : "" }} } sx={{color:'white', textTransform: 'none'}}>Home
    </Button>
    <Button component={NavLink} to="/contact" style={({isActive}
    ) => {return { backgroundColor: isActive ? "#6d1b7b" : ""}}} sx={{color:'white', textTransform: 'none'}}>Contact
    </Button>
